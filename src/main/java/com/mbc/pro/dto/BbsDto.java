// SpringSample4 - com.mbc.pro.dto - BbsDto.java
...
public class BbsDto implements Serializable {
	...
	private int ref, step, depth;	// 그룹번호, 행번호, 깊이번호
	
	private String title, content, wdate;	// 제목, 내용, 작성일
	
	private int parent;	// 부모글의 번호
	private int del, readcount;	// 삭제된 글 여부, 조회수
	...
	public BbsDto(int seq, String id) {
		this.seq = seq;
		this.id = id;
	}
